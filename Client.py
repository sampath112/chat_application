...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        self.loginLabel = customtkinter.CTkLabel(master = self.loginFrame, text = "Login System", font = ("Roboto", 24))
        ...
        self.usernameLabel = customtkinter.CTkLabel(master = self.loginFrame, text = "Username:", font = ("Roboto", 12))
        ...
        self.passwordLabel = customtkinter.CTkLabel(master = self.loginFrame, text = "Password:", font = ("Roboto", 12))
        ...
        self.signupLabel = customtkinter.CTkLabel(master = self.loginFrame, text = "New user? Sign up!", font = ("Roboto", 10))
    ...
    def SignUpPage(self):
        ...
        signUpWindowLabel = customtkinter.CTkLabel(master = signUpFrame, text = "Sign Up to NEURON", font = ("Roboto", 24))
        signUpWindowLabel.pack(pady = (12, 10), padx = 10)


        signUpUserLabel = customtkinter.CTkLabel(master = signUpFrame, text = "Enter Username:", font = ("Roboto", 12))
        ...
        signUpEmailLabel = customtkinter.CTkLabel(master = signUpFrame, text = "Enter Email:", font = ("Roboto", 12))
        ...
        signUpPassLabel = customtkinter.CTkLabel(master = signUpFrame, text = "Enter Password:", font = ("Roboto", 12))
